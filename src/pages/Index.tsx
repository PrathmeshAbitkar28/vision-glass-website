    ...
    <div ref={mainRef}>
      ...
      <section className="relative h-screen min-h-[680px] flex items-center justify-center overflow-hidden bg-black">
        ...
        <div className="relative z-10 text-center text-white px-4 max-w-5xl mx-auto pt-28 md:pt-0">
          ...
          <div className="overflow-hidden mb-1">
            <h1 className="hero-line text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold tracking-[-0.02em] leading-[1.0]">Expert in Window</h1>
          </div>
          <div className="overflow-hidden mb-8">
            <h1 className="hero-line text-5xl md:text-7xl lg:text-[5.5rem] font-extrabold tracking-[-0.02em] leading-[1.0] text-transparent bg-clip-text" style={{ backgroundImage: "linear-gradient(135deg,#7dd3fc 0%,#38bdf8 45%,#0ea5e9 100%)" }}>
              &amp; Glass Solutions
            </h1>
          </div>
          ...
          <div className="hero-btns flex flex-col sm:flex-row gap-4 justify-center">
            ...
            <Link to="/gallery">
              <Button size="lg" variant="ghost" className="rounded-full px-10 h-14 text-base text-white hover:text-white"
              ...
              <Link key={s.title} to="/services" className="gsap-card service-card-outer group relative">
                <div className="service-card-inner relative rounded-2xl overflow-hidden bg-card border border-border group-hover:border-transparent group-hover:shadow-2xl">
                  <div className="relative h-56 overflow-hidden">
                    ...
                    {/* FIX 1: removed icon badge from image overlay */}
                  ...
                  <div className="p-6">
                    ...
                    {/* FIX 2: "Learn More" always sky-blue, not per-card accent */}
                  ...
                  {/* FIX 2: bottom bar always sky-blue */}
              ...
              <div key={item.label} className="gsap-card trusted-card-outer group">
                <div className="trusted-card-inner rounded-2xl overflow-hidden border border-border" style={{ height: "232px" }}>
                  ...
                  <div className="flex flex-col justify-center items-center px-3 text-center" style={{ height: "72px", background: "var(--card)" }}>
                    ...
                    {/* FIX 1: animated bottom bar also sky-blue */}
      ...
      <section className="gsap-section py-24 md:py-16 bg-background">
        <div className="container mx-auto px-4">
          ...
          {/*
            FIX 3: equal-height cards.
            - grid row uses `items-stretch` so all cells stretch to tallest
            - inner wrapper is full height flex-col
            - description grows with flex-1 to push button to bottom
          */}
            ...
            {referCards.map((card, i) => (
              <div key={i} className="gsap-card refer-card-outer group h-full">
                <div className="refer-card-inner h-full flex flex-col relative rounded-3xl border border-border bg-card p-8 text-center overflow-hidden group-hover:shadow-2xl group-hover:border-transparent">
                  ...
                  >
                    <card.icon className="w-7 h-7" style={{ color: BLUE }} />
                  </div>
                  {/* Title */}
                  <h3 className="text-lg font-bold text-foreground mb-3 leading-snug">{card.question}</h3>
                  {/* Description — grows to push button down */}
                  <p className="text-muted-foreground text-sm leading-relaxed font-light flex-1 mb-7">{card.sub}</p>
