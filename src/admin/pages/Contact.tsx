...
const ContactManagement = () => {
  ...
  return (
    <div className="w-full space-y-10 pb-20 pt-28 px-4 md:px-10">
      
      {/* 🏛️ Professional Fixed Command Header */}
      <div className="fixed top-0 left-0 right-0 lg:left-80 z-40 px-6 md:px-10 py-5 flex flex-col md:flex-row items-center justify-between gap-6" style={{ backgroundColor: '#1e3a5f', borderBottom: '2px solid rgba(255,255,255,0.08)', boxShadow: '0 10px 30px rgba(30,58,95,0.3)' }}>
